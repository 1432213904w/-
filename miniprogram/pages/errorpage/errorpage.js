...
Page({
  ...
  goquestion: function (t) {
    if(this.data.nums == 0){
      ...
      wx.navigateTo({
        url: "../errorstar/errorstar?mode=1&ids=" + t.currentTarget.dataset.ids.join(",") + "&title=" + t.currentTarget.dataset.title + "&navtitle=我的错题&cateName="+this.data.category.name
      })
    }
